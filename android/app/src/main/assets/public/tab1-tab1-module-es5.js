    ...
    function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Tab1Page = /*#__PURE__*/function () {
        ...
        _createClass(Tab1Page, [{
          key: "getFeaturedNews",
          value: function getFeaturedNews() {
            var _this = this;

            this.http.get(_config__WEBPACK_IMPORTED_MODULE_4__["api_base_url"] + '/news/featured', {}).subscribe(function (data) {
              _this.proccessFeaturedNews(data);
            }, function (err) {
              _this.showError();
            });
          }
          ...
          value: function getStatistics() {
            ...
            this.http.get(_config__WEBPACK_IMPORTED_MODULE_4__["api_base_url"] + '/home/statistics', {}).subscribe(function (data) {
              _this2.proccessStatistics(data);
            }, function (err) {
              _this2.showError();
            });
          }
          ...
          value: function getLatestNews() {
            ...
            this.http.get(_config__WEBPACK_IMPORTED_MODULE_4__["api_base_url"] + '/news/latest', {}).subscribe(function (data) {
              _this3.proccessLatestNews(data);
            }, function (err) {
              _this3.showError();
            });
          }
        }, {
          key: "proccessFeaturedNews",
          value: function proccessFeaturedNews(data) {
            this.featuredNews = data.data;
          }
        }, {
          key: "proccessStatistics",
          value: function proccessStatistics(data) {
            this.statistics = data.data;
          }
        }, {
          key: "proccessLatestNews",
          value: function proccessLatestNews(data) {
          ...
          key: "goToNewsDetail",
          value: function goToNewsDetail(id) {
